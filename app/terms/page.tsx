        ...
        <div className="rounded-[2rem] border border-neutral-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-8 space-y-6 leading-7 text-neutral-700">
            ...
            <section>
              ...
              <p className="mt-2">
                მომხმარებლებს შორის ნივთის ყიდვა-გაყიდვა ხორციელდება უშუალოდ მყიდველსა და გამყიდველს შორის. SamoSell არ იღებს ნივთის საფასურს, არ ანაწილებს თანხას მხარეებს შორის და არ მოქმედებს როგორც escrow.
              </p>
            </section>
            <section>
              <h2 className="text-xl font-black text-neutral-900">ფასიანი ფუნქციები</h2>
              <p className="mt-2">
                SamoSell-ის ფასიანი ფუნქციებია VIP, TOP, VIP MAX და Home Banner. მათი ფასი, მომსახურების კოდი, მოქმედების ვადა, განთავსების ეფექტი, გადახდის მეთოდები და დაბრუნების პირობები მითითებულია გადახდის პირობებისა და თანხის დაბრუნების პოლიტიკის გვერდებზე.
              </p>
            </section>
          </div>
        </div>
