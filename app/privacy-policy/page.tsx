      ...
      <section className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
        <div className="rounded-[2rem] border border-neutral-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-8 space-y-6 leading-7 text-neutral-700">
            ...
            <section>
              <h2 className="text-xl font-black text-neutral-900">გადახდის მონაცემები</h2>
              <p className="mt-2">
                ფასიანი SamoSell მომსახურების შეძენისას გადახდა მუშავდება გადახდის provider-ის დაცულ გარემოში. SamoSell ინახავს მხოლოდ შეკვეთისა და გადახდის ტექნიკურ იდენტიფიკატორებს, თანხას, ვალუტას და სტატუსს, რომლებიც საჭიროა აქტივაციის, მხარდაჭერისა და დაბრუნების დასამუშავებლად. ბარათის სრული ნომერი და CVV SamoSell-ში არ ინახება.
              </p>
            </section>
            <section>
