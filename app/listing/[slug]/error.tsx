  ...
  return (
    <main className="flex min-h-[70vh] items-center justify-center bg-bg px-4">
      <section role="alert" className="ui-card w-full max-w-xl p-8 text-center">
        <div
          aria-hidden="true"
          className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-soft text-2xl font-black text-brand"
        >
          !
        </div>
        <h1 className="mt-5 text-2xl font-black text-text">
          {ka.listingDetail.errorTitle}
        </h1>
        <p className="mt-3 text-sm leading-7 text-text-soft">
          {ka.listingDetail.errorDescription}
        </p>
